...
"""
    ...
    NOT_AUTH_USER_TEXT = "CONTACT @DhashamoolamDhamu "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @DhashamoolamDhamu "
